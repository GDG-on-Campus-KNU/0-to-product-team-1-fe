...
| **State** | ![Zustand](https://img.shields.io/badge/Zustand-443E38?logo=zustand&logoColor=white) ![TanStack Query](https://img.shields.io/badge/TanStack_Query-FF4154?logo=reactquery&logoColor=white) |
...
> ⚠️ Frontend 스택은 아키텍처 다이어그램 기준으로 합리적으로 채운 초안입니다. 실제 `package.json` 기준으로 확인·보완해 주세요.
