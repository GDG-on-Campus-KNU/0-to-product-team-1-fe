...
| **BE** | Spring Boot (Docker, Raspberry Pi) | REST API, 인증, 데이터 모델 |
...
| **CI/CD** | GitHub → Build & Deploy | FE는 Vercel, BE/AI는 Docker 배포 |
...
| **Backend** | ![Spring Boot](https://img.shields.io/badge/Spring_Boot-6DB33F?logo=springboot&logoColor=white) ![Java](https://img.shields.io/badge/Java-007396?logo=openjdk&logoColor=white) ![JPA](https://img.shields.io/badge/JPA-59666C?logo=hibernate&logoColor=white) |
| **AI Server** | ![FastAPI](https://img.shields.io/badge/FastAPI-009688?logo=fastapi&logoColor=white) ![Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white) ![Gemini](https://img.shields.io/badge/Google_Gemini-8E75B2?logo=googlegemini&logoColor=white) |
...
| **Infra / DevOps** | ![Vercel](https://img.shields.io/badge/Vercel-000000?logo=vercel&logoColor=white) ![GCP](https://img.shields.io/badge/GCP-4285F4?logo=googlecloud&logoColor=white) ![Raspberry Pi](https://img.shields.io/badge/Raspberry_Pi-A22846?logo=raspberrypi&logoColor=white) ![Docker](https://img.shields.io/badge/Docker-2496ED?logo=docker&logoColor=white) ![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-2088FF?logo=githubactions&logoColor=white) |

> ⚠️ Frontend 세부 라이브러리/버전은 아키텍처 다이어그램 기준으로 작성했습니다. 실제 `package.json` 기준으로 확인·보완해 주세요.
...
> Step Back은 **FE / BE / AI** 세 개의 서비스로 구성됩니다. 각 저장소 주소는 실제 값으로 교체해 주세요.

### Frontend (Next.js)

```bash
# 사전 요구사항: Node.js 18+
git clone https://github.com/<org>/step-back-frontend.git
cd step-back-frontend
...
```bash
git clone https://github.com/<org>/step-back-backend.git
cd step-back-backend
...
```bash
git clone https://github.com/<org>/step-back-ai.git
cd step-back-ai
...
> ✅ 위 명령어/포트/환경변수 키는 **예시**입니다. 실제 저장소 설정에 맞게 채워 주세요.
...
| 이름 | 역할 | 담당 |
| :--- | :--- | :--- |
| **강민우** | Product · ML | 문제 정의 · 페르소나 · LLM 라벨링/추천 · 학습 알고리즘 · 기능 구현 |
| **한나영** | UI/UX Designer | 사용자 흐름 설계 · 와이어프레임 · Figma · 정서적 톤 디자인 |
| **박수민** | Frontend | React · Mobile-first · 캘린더/리포트 화면 · 컴포넌트 라이브러리 |
| **장성준** | Backend | Spring Boot · JPA · ERD 설계 · API · 인증 · 데이터 모델 |
| **남규민** | Backend | PostgreSQL · 인덱싱 · ML 서비스 연동 · 운영 환경 · 배포 |

<!-- TODO: GitHub 프로필/아바타를 TADAK README처럼 추가하려면 아래 형식 사용
| [이름](https://github.com/handle) | ... |
| <img src="https://avatars.githubusercontent.com/u/<id>?v=4" width="120" /> | ... |
-->
